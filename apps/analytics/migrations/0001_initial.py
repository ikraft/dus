...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('analytics_analytics', (
            ...
            ('user_agent', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('referer', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('analytics', ['Analytics'])


    def backwards(self, orm):
        # Deleting model 'Analytics'
        db.delete_table('analytics_analytics')
    ...
    models = {
        'analytics.analytics': {
            ...
            'referer': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'user_agent': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        'auth.group': {
